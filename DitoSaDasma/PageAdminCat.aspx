<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageAdminCat.aspx.cs" Inherits="DitoSaDasma.PageAdminCat" %>
...
<div class="header">
	...
	<tr>
		...
		<th class="tab"><a onclick="adminCat()"><u> CATEGORIES </u></a></th>
  ...
  <div class="leftcolumn">
    ...
    <div class="cardb">
      <h1><img class="center" src="..\pictures\where.jpg"/></h1>
	  <br />
      &emsp;&emsp;<a href="AdminAmusement.aspx"><img src="..\pictures\ia.png" style="width: 160px; height: 160px;"/></a>
	  <a href="AdminAdventure.aspx"><img src="..\pictures\iad.png" style="width: 160px; height: 160px; margin-top: 8px;"/></a>
	  <a href="AdminFamFriend.aspx"><img src="..\pictures\if.png" style="width: 160px; height: 160px;"/></a>
	  <a href="AdminHotel.aspx"><img src="..\pictures\ih.png" style="width: 160px; height: 160px;"/></a>
	  <a href="AdminHistorical.aspx"><img src="..\pictures\ihi.png" style="width: 160px; height: 160px;"/></a>
	  <a href="AdminRestaurant.aspx"><img src="..\pictures\ir.png" style="width: 160px; height: 160px;"/></a>
	<br/>
	<br/>
	</div>
  </div>
