<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Adventure2.aspx.cs" Inherits="DitoSaDasma.Adventure2" %>
  ...
  <div class="leftcolumn">
	...
	<tr>
		...
		<table>
			...
			<tr>
				<td><p style="margin-left: 15px;"><b>Address: </b><br/>51 Governor's Dr, Dasmariñas, Cavite<br/><i>Near SM City Dasmariñas</i></p></td>				
				<td>
				<div class="slideshow-containerL">
					<div class="mySlidesL fadeL">
						<img src="..\adventure\adjabez.jpg" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
					<div class="mySlidesL fadeL">
						<img src="..\adventure\adjabez2.jpg" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
					<div class="mySlidesL fadeL">
						<img src="..\adventure\adjabez3.jpg" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
				</div>
				<br/>
				...
				<td><p><b> Get directions: </b><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3866.2166226855634!2d120.95889656475539!3d14.298842689995222!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397d593519b75c5%3A0xee4881e49676477b!2sJabez%20Campsite!5e0!3m2!1sen!2sph!4v1657497700700!5m2!1sen!2sph" width="190" height="190" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></p> </td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><h2 style="text-align: center;"> Jabez Campsite </h2><p style="text-align: center;">Jabez Campsite provides facilities conducive for retreats, conferences, seminars and other spiritual activities that will promote and strengthen personal intimacy with God.
					<br/> <a href="https://www.cgm.ph/index.php/our-ministries/jabez-campsite/package-rate" target="_blank">Click here to know what they have and its prices</a></p></td>
				<td>&nbsp;</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><p style="text-align: center;"><img style="height: 30px; width: 30px;" src="..\pictures\fb.png"/>&nbsp;<a href="https://web.facebook.com/cgmjabezcampsite" target="_blank">Jabez Campsite</a>&emsp;<img style="height: 30px; width: 30px;" src="..\pictures\phone.png" />&nbsp;(046) 416 6774 / (046)416-6775 / 0920-954-0497 </p></td>
				<td>&nbsp;</td>
			</tr>
		</table>
	</div>
