<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FamFriend4.aspx.cs" Inherits="DitoSaDasma.FamFriend4" %>
  ...
  <div class="leftcolumn">
	...
	<tr>
		...
		<table>
			...
			<tr>
				<td><p style="margin-left: 15px;"><b>Address: </b><br/>Molino - Paliparan Rd, Salawag, Dasmariñas, Cavite<br/><i>Near 7-Eleven</i><br/><br/> <b>Schedule: </b><br/>Sunday - Saturday <br/> 10:00PM - 7:00PM</p></td>				
				<td>
				<div class="slideshow-containerL">
					<div class="mySlidesL fadeL">
						<img src="..\famfriendly\ffdistrict.jpg" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
					<div class="mySlidesL fadeL">
						<img src="..\famfriendly\ffdistrict2.jpg" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
				</div>
				<br/>
				...
				<td><p><b> Get directions: </b><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15460.643259934137!2d120.97330967945318!3d14.360103627446339!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397d400d30ac563%3A0x2a52113b04943b7!2sThe%20District%20Dasmari%C3%B1as%20by%20Ayala%20Malls!5e0!3m2!1sen!2sph!4v1657520665087!5m2!1sen!2sph" width="190" height="190" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></p> </td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><h2 style="text-align: center;"> The District Dasmariñas by Ayala Malls </h2><p style="text-align: center;">The District Dasmariñas (TDD), a community center that offers shopping, dining, entertainment, and service concepts.</p></td>
				<td>&nbsp;</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><p style="text-align: center;"><img style="height: 30px; width: 30px;" src="..\pictures\fb.png"/>&nbsp;<a href="https://www.facebook.com/TheDistrictDasmarinas/" target="_blank" >The District Dasmariñas</a>&emsp;<img style="height: 30px; width: 30px;" src="..\pictures\phone.png" />&nbsp;0942 390 4028</p></td>
				<td>&nbsp;</td>
			</tr>
		</table>
	</div>
