<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Restaurant5.aspx.cs" Inherits="DitoSaDasma.Restaurant5" %>
  ...
  <div class="leftcolumn">
	...
	<tr>
		...
		<table>
			...
			<tr>
				<td><p style="margin-left: 15px;"><b>Address: </b><br/>215 San Agustin II, E. Aguinaldo Highway, Dasmariñas, Cavite <br/><i>Near Vista Mall Dasmariñas</i><br/><br/> <b>Schedule: </b><br/>Monday - Thursday <br/> 10:00AM - 9:00PM<br/>Friday - Sunday <br/> 10:00AM - 10:00PM</p></td>				
				<td>
				<div class="slideshow-containerL">
					<div class="mySlidesL fadeL">
						<img src="..\restaurant\rlogo5.jpg" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
					<div class="mySlidesL fadeL">
						<img src="..\restaurant\rdayo.jpg" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
					<div class="mySlidesL fadeL">
						<img src="..\restaurant\rdayo2.jpg" style="height:300px; width: 400px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
				</div>
				<br/>
				...
				<td><p><b> Get directions: </b><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3865.9252810566977!2d120.94254757712135!3d14.315772792516455!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397d562ed52ec67%3A0xf304c6cededd75c8!2sDAYO%20Kapihan%20Atbp!5e0!3m2!1sen!2sph!4v1657024809187!5m2!1sen!2sph" width="190" height="190" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></p> </td>
            </tr>
			<tr>
				<td>&nbsp;</td>
				<td><h2 style="text-align: center;"> DAYO Kapihan Atbp. </h2><p style="text-align: center;">The DAYO Kapihan atbp. is a local cafe where Filipino flavors are gathered. Apart from the favorite coffee, there is also breakfast, lunch, and dinner when you visit DAYO Kapihan atbp.</p></td>
				<td>&nbsp;</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><p style="text-align: center;"><img style="height: 30px; width: 30px;" src="..\pictures\fb.png"/>&nbsp;<a href="https://web.facebook.com/dayokapihanatbp" target="_blank">DAYO Kapihan atbp.</a>&emsp;<img style="height: 30px; width: 30px;" src="..\pictures\phone.png" />&nbsp;0995 996 3438</p></td>
				<td>&nbsp;</td>
			</tr>
		</table>
	</div>
