<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminAmusement.aspx.cs" Inherits="DitoSaDasma.AdminAmusement" %>
...
<div class="cardb">
	...
	<tr>
		...
		<th class="tabimg"><img src="..\pictures\ctAm.png" class="center" style="width: 450px; height: 100px; border-radius: 25px"/></th>	
		<th class="tab"></th>
	</tr>
	</table>
	<br/>
	...
	<tr>
		...
		<table>
			...
			<tr> 
				<td>&nbsp;</td>
				<td>&nbsp;</td>
				<td><img src="..\pictures\am1.png" style="height:130px; width:575px;"/></td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
			</tr>
			<tr>
			...
			<tr>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
				<td><img src="..\pictures\am2.png" style="height:130px; width:575px;"/></td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
			</tr>
		</table>
