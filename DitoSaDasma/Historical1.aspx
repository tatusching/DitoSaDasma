<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Historical1.aspx.cs" Inherits="DitoSaDasma.Historical1" %>
  ...
  <div class="leftcolumn">
	...
	<tr>
		...
		<table>
			...
			<tr>
				<td><p style="margin-left: 15px;"><b>Address: </b><br/>Congressional Ave, Dasmariñas, Cavite<br/><i>Near DASCA and Pagamutan ng Dasmariñas</i></p></td>				
				<td>
				<div class="slideshow-containerL">
					<div class="mySlidesL fadeL">
						<img src="..\historical\edsa.jpg" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
					<div class="mySlidesL fadeL">
						<img src="..\historical\edsa2.jpg" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
					<div class="mySlidesL fadeL">
						<img src="..\historical\edsa2.jpg" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
				...
				<td><p><b> Get directions: </b><iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d2774.114475662274!2d120.96131871884252!3d14.324265915413452!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x20c419f1c7327bea!2sEDSA%20Revolution%20Monument!5e0!3m2!1sen!2sph!4v1657508081844!5m2!1sen!2sph" width="190" height="190" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></p> </td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><h2 style="text-align: center;"> EDSA Revolution Monument </h2><p style="text-align: center;">The monument features seven individuals who played important roles in the historic 1986 EDSA Revolution, such as former presidents and officials.</p></td>
				<td>&nbsp;</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
