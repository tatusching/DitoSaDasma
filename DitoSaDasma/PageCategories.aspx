<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageCategories.aspx.cs" Inherits="DitoSaDasma.PageCategories" %>
...
<div class="header">
	...
	<tr>
		...
		<th class="tab"><a onclick="categories()"><u> CATEGORIES </u></a></th>
...
<div class="row">
  <div class="leftcolumn">
    ...
    <div class="cardb">
	  ...
	  <br />
      &emsp;&emsp;<a href="CatAmusement.aspx"><img src="..\pictures\ia.png" style="width: 160px; height: 160px;"/></a>
	  <a href="CatAdventure.aspx"><img src="..\pictures\iad.png" style="width: 160px; height: 160px; margin-top: 8px;"/></a>
	  <a href="CatFamFriend.aspx"><img src="..\pictures\if.png" style="width: 160px; height: 160px;"/></a>
	  <a href="CatHotel.aspx"><img src="..\pictures\ih.png" style="width: 160px; height: 160px;"/></a>
	  <a href="CatHistorical.aspx"><img src="..\pictures\ihi.png" style="width: 160px; height: 160px;"/></a>
	  <a href="CatRestaurant.aspx"><img src="..\pictures\ir.png" style="width: 160px; height: 160px;"/></a>
	<br/>
	<br/>
	</div>
  </div>
