<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FamFriend3.aspx.cs" Inherits="DitoSaDasma.FamFriend3" %>
  ...
  <div class="leftcolumn">
	...
	<tr>
		...
		<table>
			...
			<tr>
				<td><p style="margin-left: 15px;"><b>Address: </b><br/>Daño St, Dasmariñas, Cavite<br/><i>Near Metrobank Dasmariñas - Cavite</i><br/></p></td>				
				<td>
				<div class="slideshow-containerL">
					<div class="mySlidesL fadeL">
						<img src="..\famfriendly\fflover.jpg" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
					<div class="mySlidesL fadeL">
						<img src="..\famfriendly\fflover2.jpg" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
					<div class="mySlidesL fadeL">
						<img src="..\famfriendly\fflover3.jpg" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
				</div>
				<br/>
				...
				<td><p><b> Get directions: </b><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15463.299052106187!2d120.9318729794472!3d14.321609431409458!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397d5a5dbb97b95%3A0x756400487637825d!2sLover&#39;s%20Park%20Dasmari%C3%B1as!5e0!3m2!1sen!2sph!4v1657519997041!5m2!1sen!2sph" width="190" height="190" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></p> </td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><h2 style="text-align: center;"> Lover's Park </h2></td>
				<td>&nbsp;</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
