<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Historical2.aspx.cs" Inherits="DitoSaDasma.Historical2" %>
  ...
  <div class="leftcolumn">
	...
	<tr>
		...
		<table>
			...
			<tr>
				<td><p style="margin-left: 15px;"><b>Address: </b><br/>Don Placido Campos Avenue, Dasmariñas, Cavite<br/><i>Near City Hall of Dasmariñas</i></p></td>				
				<td>
				<div class="slideshow-containerL">
					<div class="mySlidesL fadeL">
						<img src="..\historical\hmchurch.jpg" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
					<div class="mySlidesL fadeL">
						<img src="..\historical\hmchurch1.jpg" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
					<div class="mySlidesL fadeL">
						<img src="..\historical\hmchurch2.jpg" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
					<div class="mySlidesL fadeL">
						<img src="..\historical\hmchurch3.jpg" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
				</div>
				<br/>
				...
				<td><p><b> Get directions: </b><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3865.7245767564614!2d120.93394351483697!3d14.32742448997694!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397d50202adf6a5%3A0xae7e3ac66f57f8f2!2sImmaculate%20Conception%20Parish!5e0!3m2!1sen!2sph!4v1657508916874!5m2!1sen!2sph" width="190" height="190" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></p> </td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><h2 style="text-align: center;"> Immaculate Conception Parish Church </h2><p style="text-align: center;">
The Immaculate Conception Parish Church, also known as the Dasmariñas Church, is the first Catholic parish church in the city of Dasmariñas, province of Cavite, Philippines.</p></td>
				<td>&nbsp;</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><p style="text-align: center;"><img style="height: 30px; width: 30px;" src="..\pictures\fb.png"/>&nbsp;<a href="https://web.facebook.com/icpdasma08" target="_blank">Immaculate Conception Parish Church</a>&emsp;<img style="height: 30px; width: 30px;" src="..\pictures\phone.png" />&nbsp;(046) 416 0797</p></td>
				<td>&nbsp;</td>
			</tr>
		</table>
	</div>
