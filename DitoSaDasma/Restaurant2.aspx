<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Restaurant2.aspx.cs" Inherits="DitoSaDasma.Restaurant2" %>
			...
			<tr>
				...
				<div class="slideshow-containerL">
					<div class="mySlidesL fadeL">
						<img src="..\restaurant\rlogo6.1.png" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
					<div class="mySlidesL fadeL">
						<img src="..\restaurant\rvine3.jpg" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
					<div class="mySlidesL fadeL">
						<img src="..\restaurant\rvine2.jpg" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
                    <div class="mySlidesL fadeL">
						<img src="..\restaurant\rvine.jpg" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
				</div>
				<br/>
				...
				<td><p><b> Get directions: </b> <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1210.3284080565693!2d120.96277989773176!3d14.279507584736061!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397d54d4549bcfb%3A0xfdc6e9d0e3752e50!2sThe%20VINE%20Al%20Fresco!5e0!3m2!1sen!2sph!4v1657027947138!5m2!1sen!2sph" width="190" height="190" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe> </p> </td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><h2 style="text-align: center;"> The VINE Al Fresco </h2><p style="text-align: center;">The VINE Al Fresco (Open Air) Restaurant offer Unlimited Samgyupsal, Seafoods, Wings, Ribs and many more.</p></td>
				<td>&nbsp;</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><p style="text-align: center;"><img style="height: 30px; width: 30px;" src="..\pictures\fb.png"/>&nbsp;<a href="https://web.facebook.com/thevinealfresco" target="_blank" >The Vine Al Fresco</a>&emsp;<img style="height: 30px; width: 30px;" src="..\pictures\phone.png" />&nbsp;0917 821 8153</p></td>
				<td>&nbsp;</td>
			</tr>
		</table>
	</div>
