<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Restaurant3.aspx.cs" Inherits="DitoSaDasma.Restaurant3" %>
  ...
  <div class="leftcolumn">
	...
	<tr>
		...
		<table>
			...
			<tr>
				<td><p style="margin-left: 10px;"><b>Address: </b><br/>106 Don Placido Campos Avenue, Dasmariñas, Cavite<br/><i>Near BPI Bank, Andok's, Novo in Dasma Bayan</i><br/><br/> <b>Schedule: </b><br/>Sunday - Saturday <br/> 10:00AM - 9:00PM</p></td>				
				<td>
				<div class="slideshow-containerL">
					<div class="mySlidesL fadeL">
						<img src="..\restaurant\rlogo4.png" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
					<div class="mySlidesL fadeL">
						<img src="..\restaurant\rsari.jpg" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
					<div class="mySlidesL fadeL">
						<img src="..\restaurant\rsari2.jpg" style="height:300px; width: 400px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
				</div>
				<br/>
				...
				<td><p><b> Get directions: </b><iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15463.094727252117!2d120.9369904!3d14.3245746!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x2c6f910aae6d012f!2sSari%20Your%20Local%20Store%20and%20Caf%C3%A9!5e0!3m2!1sen!2sph!4v1657432690383!5m2!1sen!2sph" width="190" height="190" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></p></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><h2 style="text-align: center;"> Sari: Your Local Store & Cafe </h2><p style="text-align: center;">Sari: Your Local Store & Cafe is a proudly homegrown cafe and restaurant serving great local coffee, irresistible milkshakes and delicious comfort food. Highly rated, and featured on GMA, ABS-CBN, Viva TV, Manila Bulletin, Manila Standard, and Malaya Business Insight.</p></td>
				<td>&nbsp;</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><p style="text-align: center;"><img style="height: 30px; width: 30px;" src="..\pictures\fb.png"/>&nbsp;<a href="https://web.facebook.com/saristorecafe" target="_blank">Sari: Your Local Store & Cafe</a>&emsp;<img style="height: 30px; width: 30px;" src="..\pictures\phone.png" />&nbsp;(046) 416 5582</p></td>
				<td>&nbsp;</td>
			</tr>
		</table>
	</div>
