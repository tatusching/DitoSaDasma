<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Historical3.aspx.cs" Inherits="DitoSaDasma.Historical3" %>
...
<div class="row">
  <div class="leftcolumn">
	...
	<table>
	<tr>
		<th class="tab"><a href="CatHistorical.aspx"> <img src="..\pictures\back.png" style="width: 50px; height: 50px; margin-top: 20px;"/></a></th>
		...
		<table>
			...
			<tr>
				<td><p style="margin-left: 15px;"><b>Address: </b><br/>East Campus, De La Salle University – Dasmariñas, Cavite<br/><i>Inside De La Salle University - Dasmariñas</i><br/><br/><b>Schedule: <br/></b>Monday - Sunday<br/>9:00 AM – 12:00 PM<br/>1:00 PM – 3:30 PM<br/><br/><b>Fees: </b><br/>P40 students; P100 adults.</p></td>				
				<td>
				<div class="slideshow-containerL">
					<div class="mySlidesL fadeL">
						<img src="..\historical\hmmuseo.jpg" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
					<div class="mySlidesL fadeL">
						<img src="..\historical\hmmuseo2.jpg" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
					<div class="mySlidesL fadeL">
						<img src="..\historical\hmmuseo3.png" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
					<div class="mySlidesL fadeL">
						<img src="..\historical\hmmuseo4.png" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
					<div class="mySlidesL fadeL">
						<img src="..\historical\hmmuseo5.png" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
				</div>
				<br/>
				...
				<td><p><b> Get directions: </b><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1670.5246225958106!2d120.96038125374587!3d14.321145331762983!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397d5b45a6c4e65%3A0xaa052ae8cd1fe5f6!2sMuseo%20De%20La%20Salle!5e0!3m2!1sen!2sph!4v1657509807671!5m2!1sen!2sph" width="190" height="190" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></p> </td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><h2 style="text-align: center;"> Museo De La Salle </h2><p style="text-align: center;">Museo De La Salle is a lifestyle museum dedicated to the preservation of certain aspects & material culture of the 19th c. Philippine ilustrado lifestyle.</p></td>
				<td>&nbsp;</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><p style="text-align: center;"><img style="height: 30px; width: 30px;" src="..\pictures\fb.png"/>&nbsp;<a href="https://web.facebook.com/museodelasalledasma" target="_blank">Museo De La Salle</a>&emsp;<img style="height: 30px; width: 30px;" src="..\pictures\phone.png" />&nbsp;(046) 481 1940</p></td>
				<td>&nbsp;</td>
			</tr>
		</table>
	</div>
