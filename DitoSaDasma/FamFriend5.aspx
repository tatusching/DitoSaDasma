\<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FamFriend5.aspx.cs" Inherits="DitoSaDasma.FamFriend5" %>
  ...
  <div class="leftcolumn">
	...
	<tr>
		...
		<table>
			...
			<tr>
				<td><p style="margin-left: 15px;"><b>Address: </b><br/>Gen. E. Aguinaldo Highway corner Governors Drive, Sitio Palapala, Dasmariñas, Cavite<br/><i>Near Iglesia Ni Cristo - Lokal ng New Era</i><br/><br/> <b>Schedule: </b><br/>Sunday - Saturday <br/> 10:00AM - 9:00PM</p></td>				
				<td>
				<div class="slideshow-containerL">
					<div class="mySlidesL fadeL">
						<img src="..\famfriendly\ffrob.jpg" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
					<div class="mySlidesL fadeL">
						<img src="..\famfriendly\ffrob2.jpg" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
				</div>
				<br/>
