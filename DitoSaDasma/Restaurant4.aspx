<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Restaurant4.aspx.cs" Inherits="DitoSaDasma.Restaurant4" %>
  ...
  <div class="leftcolumn">
	...
	<tr>
		...
		<table>
			...
			<tr>
				<td><p style="margin-left: 10px;"><b>Address: </b><br/>2nd Floor, Marushima Building, Brgy. San Agustin III, Emilio Aguinaldo Highway, Dasmariñas, Cavite <br/><i>Near KIA & Nissan Showroom</i><br/><br/> <b>Schedule: </b><br/>Sunday - Saturday <br/> 12:00NN - 9:00PM</p></td>				
				<td>
				<div class="slideshow-containerL">
					<div class="mySlidesL fadeL">
						<img src="..\restaurant\rlogo7.jpg" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
					<div class="mySlidesL fadeL">
						<img src="..\restaurant\rbon.jpg" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
					<div class="mySlidesL fadeL">
						<img src="..\restaurant\rbon2.jpg" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
					<div class="mySlidesL fadeL">
						<img src="..\restaurant\rbon3.jpg" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
					<div class="mySlidesL fadeL">
						<img src="..\restaurant\rbon4.jpg" style="height:300px; display: block; margin-left: auto; margin-right: auto;"/>
						<div class="aboutdasma" style="text-align:right;"> Source: Facebook </div>
					</div>
				</div>
				<br/>
				...
				<td><p><b> Get directions: </b><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3865.837604904597!2d120.93962745027895!3d14.320863889931964!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397d50756754723%3A0xcc21dfaea3443279!2sBon%20Appetea%20Dasma!5e0!3m2!1sen!2sph!4v1657452810209!5m2!1sen!2sph" width="190" height="190" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></p></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><h2 style="text-align: center;"> Bon Appetea </h2><p style="text-align: center;">Bon Appetea offers a wide variety of menu, aside from Milk Teas, Fruit Teas & Frappes, we're also offering All Day Breakfast Rice Meals, Waffles, Pasta & Fries.</p></td>
				<td>&nbsp;</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><p style="text-align: center;"><img style="height: 30px; width: 30px;" src="..\pictures\fb.png"/>&nbsp;<a href="https://web.facebook.com/bonappeteaph" target="_blank">Bon Appetea</a></p></td>
				<td>&nbsp;</td>
			</tr>
		</table>
	</div>
