<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageSignIn.aspx.cs" Inherits="DitoSaDasma.PageSignIn" %>
...
<div class="row">
  <div class="leftcolumn">
    ...
    <div class="cardb">
        <br/>
      <img class="center" src="..\pictures\signin.jpg"/>
		<br/>
        <form id="form1" runat="server"><!--action="/action_page.php" ~ DATABASE-->
			<table>
				<tr>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				...
				<tr>
					<td>&emsp;&emsp;&emsp;&emsp;&emsp;&ensp;</td>
					<td>&emsp;&emsp;&emsp;&emsp;&emsp;&ensp;</td>
					<td>&emsp;&emsp;&emsp;&emsp;&emsp;&ensp;</td>
					<td>&emsp;&emsp;&emsp;&emsp;&emsp;&ensp;</td>
				...
				<tr>   
					...
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<th > <label for="confpw">Confirm password:</label> </th>
					<th > <input type="password" id="confpw" name="confpw" /></th>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					...
					<td>&nbsp;</td>
					<td>
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBConnectionString %>" SelectCommand="SELECT * FROM [UserInfoDB]"></asp:SqlDataSource>
                    </td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					...
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td > <button type="submit" onclick="logIn()">Sign In</button> </td>
				</tr>
			</table>
            <br/>
            </form>
